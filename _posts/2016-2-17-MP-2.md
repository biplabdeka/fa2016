...
4. Your redesign should draw on the visual design principles discussed in class:
 ...
 2. contrast should be used to give visual weight to important areas
 3. use variations in font, size, weight, and style to create typographic contrast
 4. use whitespace to perceptually group related elements and separate semantically different areas
 5. use margins, leading, and adequate background/text color contrast to make text more readable
 6. choose fonts and colors that match the mood/message/content of your site
