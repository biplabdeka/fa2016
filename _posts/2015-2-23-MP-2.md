...
+ If you have additional assets (say pictures) you should create a new `public/assets` folder and put everything there or in its subfolders (say `public/assets/pics` and `public/assets/videos`). There should be no other place in your folder structure where you are loading assets from.
