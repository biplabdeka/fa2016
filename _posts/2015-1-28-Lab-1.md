...
source ~/.profile
```
 8 - **Fork** the [MP-1 starter code](https://github.com/uiuc-web-programming/mp1_starter) from the class github repo (by clicking on the fork button on the top right). You'll have to have a github account to be able to do this. Then clone it to your machine and inspect the files inside by using the following commands
