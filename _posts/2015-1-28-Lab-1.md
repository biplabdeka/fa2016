...
<span style="color: red"> Warning: </span>  **Do not edit anything under the `public/css` or `public/js` folder.** All things there are auto-generated and any changes you make there will get overwritten by Grunt.
