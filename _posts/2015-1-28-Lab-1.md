...
1.1: The `mp1_starter` code has changed. Step 14 under Development Environment Setup is new.
...
grunt
```
14 - Open your browser and point it to `localhost:3000`. You should see the served webpage there. If you leave grunt running and now make changes to the files in the `source_scss` folder, the `source_js` folder and the `source_html` folder, you will see the webpage reload automatically. This is done through [grunt livereload](https://github.com/gruntjs/grunt-contrib-watch#optionslivereload). This way you can code away on your code editor while seeing changes in the browser side by side.
